...
$(document).ready(function() {
    ...
    $('#clockImage').countdown('2018/8/10').on('update.countdown', function(event) {
      var $this = $(this).html(event.strftime(''
        ...
        + '<div class="clockCard p-2 mr-1 mb-3 bg-cyan bg-darken-4 box-shadow-2"> <span>%M</span> <br> <p class="lead mb-0">Minit </h5> </div>'
        + '<div class="clockCard p-2 mb-3 bg-cyan bg-darken-4 box-shadow-2"> <span>%S</span> <br> <p class="lead mb-0"> Saat </p> </div>'))
    });
